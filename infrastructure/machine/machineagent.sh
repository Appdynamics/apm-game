...
then
	...
	sed -i -e "s#ad.agent.name=analytics-agent1#ad.agent.name=${APPDYNAMICS_ANALYTICS_AGENT_NAME}#" /opt/appdynamics/monitors/analytics-agent/conf/analytics-agent.properties
